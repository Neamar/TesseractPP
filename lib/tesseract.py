...
tesseract_cmd = '/home/neamar/Documents/app/tesseract/3.02.02/bin/tesseract'
...
def run_tesseract(input_filename, output_filename_base, lang=None, boxes=False, french_chars_only=True):
    '''
    runs the command:
